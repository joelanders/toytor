...
class TestAsyncCreate:
    ...
    async def test_async_create(self):
        ...
        skeys = handle_create(s_reader, s_writer, node_id, server_key, create_cell)
...
class TestExtend2:
    def test_build_extend2(self):
        ...
        c = torpylle.CellRelayExtend2(
                      ...
                      StreamID=79,
                      LSpec=b'\x7f\x00\x00\x01\x23\x8b', # 127.0.0.1:9099 i think
    ...
    def test_read_extend2(self):
        ...
        bites += b'\x7f\x00\x00\x01\x23\x8b' # 127.0.0.1:9099 i think
        bites += b'\x00\x02' # Htype = ntor
        bites += b'\x00\x54' # Hlen = 84 decimal
        bites += b'n'*20 # NodeId
        bites += b'k'*32 # KeyId
...
class TestEncryptRelayCell:
    def test_one_hop(self):
        ...
        or_state = CircuitHop(shared_keys) # really an OR only ever decrypts one layer at a time
    ...
    def test_two_hop(self):
        ...
        print(repr(encrypted))
        # decrypted = decrypt_relay_cell( [or_state1, or_state2], encrypted, 'fw' )
